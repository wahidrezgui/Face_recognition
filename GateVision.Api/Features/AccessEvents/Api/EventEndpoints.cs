...
public static class EventEndpoints
{
    ...
    public static void MapEventEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("/api/v1/events/{id:guid}/review", async (Guid id, ReviewEventDto dto, AppDbContext db, EventBufferService buffer, ILogger<Program> logger, CancellationToken ct) =>
        {
        ...
        app.MapDelete("/api/v1/events/{id:guid}", async (Guid id, AppDbContext db, ILogger<Program> logger, CancellationToken ct) =>
        {
        ...
        app.MapGet("/api/v1/training-events", async (AppDbContext db, CancellationToken ct,
            int page = 1, int limit = 50,
            string? name = null, string? status = null) =>
        {
            limit = Math.Min(limit, 200);
        ...
        app.MapPatch("/api/v1/training-events/{id:guid}", async (Guid id, UpdateTrainingEventDto dto, AppDbContext db, ILogger<Program> logger, CancellationToken ct) =>
        {
