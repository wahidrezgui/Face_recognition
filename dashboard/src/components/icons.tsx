...
export const IconDot = ({ online }: { online: boolean }) => (
  <span className={`inline-block w-2 h-2 rounded-full ${online ? "bg-emerald-400 shadow-[0_0_6px_rgba(52,211,153,0.8)]" : "bg-red-500"}`} />
);
