...
interface Props {
    ...
    editOpen: boolean;
    panelWidth: string;
    createForm: InertiaForm<DepartmentFormData>;
    editForm: InertiaForm<DepartmentFormData>;
    ...
    editParentDepartmentOptions: TreeSelectOption[];
}
...
<template>
    <AppSidePanel
        ...
        as-form
        :width="panelWidth"
        :title="trans('departments.form.createTitle')"
        :subtitle="trans('departments.form.createSubtitle')"
        :close-aria-label="trans('departments.form.cancel')"
    ...
    >
        <div class="space-y-4">
            <FormField
                :label="trans('departments.form.parentLabel')"
                v-slot="{ id }"
            >
                <TreeSelect
                    :input-id="id"
                    ...
                    append-to="body"
                    :placeholder="trans('departments.form.parentPlaceholder')"
                    show-clear
                    filter
                    filter-mode="lenient"
                    :filter-placeholder="
                        trans('departments.form.parentFilterPlaceholder')
                    "
                    fluid
            ...
            <FormField
                :label="trans('departments.form.nameEnLabel')"
                required
            ...
            >
                <InputText
                    ...
                    fluid
                    dir="ltr"
                    :placeholder="trans('departments.form.nameEnPlaceholder')"
                    :invalid="!!createForm.errors.name_en"
                />
            </FormField>

            <FormField
                :label="trans('departments.form.nameArLabel')"
                v-slot="{ id }"
            >
                <InputText
                    :id="id"
                    ...
                    fluid
                    :placeholder="trans('departments.form.nameArPlaceholder')"
                />
            </FormField>
            ...
            <div>
                <label
                    ...
                    >{{ trans('departments.form.linkedBases') }}</label
                >
                <div
                    v-if="bases.length === 0"
                    class="text-sm text-surface-500 dark:text-surface-400"
                >
                    {{ trans('departments.form.noBases') }}
                </div>
        ...
        <template #footer>
            <div class="flex justify-end gap-3">
                <AppButton
                    ...
                    severity="secondary"
                    outlined
                    :label="trans('departments.form.cancel')"
                ...
                <AppButton
                    ...
                    :label="
                        createForm.processing
                            ? trans('departments.form.saving')
                            : trans('departments.form.save')
                    "
                />
            </div>
        </template>
    ...
    <AppSidePanel
        ...
        as-form
        :width="panelWidth"
        :title="trans('departments.form.editTitle')"
        :subtitle="trans('departments.form.editSubtitle')"
        :close-aria-label="trans('departments.form.cancel')"
