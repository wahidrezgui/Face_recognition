<template>
  <PageContainer title="Daily Issues Reports" description="تقارير التأخير اليومية">
...
import { useToast } from 'primevue/usetoast';
  ...
  export default {
    mixins: [createReportPageMixin('issues')],
    components: {
      ReportNavCards,
      ReportSearchPanel,
      ReportDataGrid,
      ...
      OnClicked(event){
        ...
        onBtPdf() {
          ...
          .then(response => {
            ...
            printWindow.document.write('<h1>تقارير التأخير اليومية</h1>');
        ...
        onBtExport() {
          ...
          .then(response => {
            ...
            this.$refs.reportGrid.exportDataAsCsv({
              ...
              fileName: 'DailyIssues-Report.csv', // Customize file name
            });
          })
          .finally(() => {
            this.isLoading = false; // Stop loading indicator
